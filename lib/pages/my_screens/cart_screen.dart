      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text(
              "${Provider.of<AppProvider>(context, listen: false).cartProducts.length} items",
                  ...
                  return Container(
                    ...
                    child: Dismissible(
                      ...
                      onDismissed: (direction) {
                        provider
                            .deleteCartProduct(provider.cartProducts[index].id);
                      },
                                      ...
                                      RoundedIconBtn(
                                        ...
                                        press: () {
                                          ...
                                          provider.editProduct(
                                              ...
                                              name1: provider
                                                  .cartProducts[index].name,
                                              des: provider.cartProducts[index]
                                                  .description,
                                              catID: provider
                                                  .cartProducts[index]
                                                  .categoryId,
